# Azure-CopyAzFwPolicy / Azure-CopyAzFwRules

Copy Azure Firewall Policy or Rules

## Description

This repo contains two scripts: Azure-CopyAzFwPolicy and Azure-CopyAzFwRules.
...
**Azure-CopyAzFwRules**\
This script only copies an Azure Firewall Policy rule collections and rules from one subscription to another.
...
.\Copy-AzFwRules.ps1 -SourceAzFwPolicyID "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-source/providers/Microsoft.Network/FirewallPolicies/azfw-source" -TargetAzFwPolicyID "/subscriptions/11111111-1111-1111-1111-111111111111/resourceGroups/rg-target/providers/Microsoft.Network/FirewallPolicies/azfw-target"
```